...
export async function POST(request: NextRequest) {
  try {
    ...
    try {
      const prompt = `Create a beautiful, high-quality background image related to depicting ${topic}. The image should be visually appealing, professional, and suitable as a background for a quiz application. Style: modern, colorful, and engaging.`;
