      ...
      <div className="glass-card p-8 max-w-3xl w-full">
        ...
        <div className="mb-6">
          <div className="flex justify-between items-center mb-4">
            <div>
              <h2 className="text-2xl font-bold">{quizData.topic}</h2>
              <p className="text-gray-400 text-sm capitalize">{quizData.difficulty} Difficulty</p>
            </div>
            <div className={`text-3xl font-bold ${timeLeft < 60 ? 'text-red-400 animate-pulse' : 'text-blue-400'}`}>
              {formatTime(timeLeft)}
            </div>
          </div>
            ...
            {quizData.questions.map((_, index) => (
              <div
                ...
                className={`w-2 h-2 rounded-full ${
                  selectedAnswers[index] !== null ? 'bg-blue-500' : 'bg-white/20'
                }`}
              ></div>
            ))}
          </div>
