...
export default function Quiz() {
  ...
  if (quizData.backgroundImage && !quizData.backgroundImage.startsWith('linear-gradient')) {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-4" style={backgroundStyle}>
