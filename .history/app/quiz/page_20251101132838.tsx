...
export default function Quiz() {
  ...
  return (
    ...
    >
      ...
      <div className="solid-dark-card p-8 max-w-3xl w-full">
        {/* Header */}
        <div className="mb-6">
        ...
        {/* Question */}
        <div className="mb-8">
          <h3 className="text-xl font-semibold mb-6 text-white">{currentQ.question}</h3>
              ...
              <button
                ...
                className={`w-full text-left p-4 rounded-xl border-2 transition-all duration-200 ${
                  selectedAnswers[currentQuestion] === index
                    ...
                    : "border-slate-600 bg-slate-800/80 hover:border-blue-400 hover:bg-slate-700/80 text-white"
                }`}
              >
