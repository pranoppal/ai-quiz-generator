...
export default function Quiz() {
  ...
  if (
    ...
    backgroundStyle.backgroundSize = "60%";
    backgroundStyle.backgroundPosition = "bottom 5% right 5%";
  ...
  return (
    <div
      className="min-h-screen flex flex-col items-start justify-start p-6 pt-8"
      style={backgroundStyle}
    >
      {/* Dark overlay for better readability */}
      <div className="fixed inset-0 bg-black/50 -z-10"></div>
      <div className="glass-card p-8 max-w-2xl w-full md:max-w-3xl">
        {/* Header */}
        <div className="mb-6">
          <div className="flex justify-between items-center mb-4">
            <div>
              <h2 className="text-2xl font-bold text-white text-contrast">
                {quizData.topic}
              </h2>
              <p className="text-gray-200 text-sm capitalize text-contrast">
                {quizData.difficulty} Difficulty
              </p>
            </div>
            <div
              className={`text-3xl font-bold text-contrast ${
        ...
        {/* Question */}
        <div className="mb-8">
          <h3 className="text-xl font-semibold mb-6 text-white text-contrast">
            {currentQ.question}
          </h3>
          ...
          <div className="space-y-3">
            {currentQ.options.map((option, index) => (
              <button
                ...
                className={`w-full text-left p-4 rounded-xl border-2 transition-all duration-200 text-white text-contrast ${
      ...
      {quizData.imageAttribution && (
        <div className="fixed bottom-4 right-4 text-right text-xs text-gray-300 text-contrast bg-black/30 backdrop-blur-sm px-3 py-2 rounded-lg">
          <p>
