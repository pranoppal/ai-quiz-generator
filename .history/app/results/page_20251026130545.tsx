        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="glass-card p-6 mb-6">
            ...
            <div className="flex gap-4 text-sm">
              ...
              <span className="text-gray-400">
                Correct: <span className="text-green-400 font-semibold">{result.correctAnswers}</span>
              </span>
              <span className="text-gray-400">
                Wrong: <span className="text-red-400 font-semibold">{result.totalQuestions - result.correctAnswers}</span>
              </span>
            </div>
          </div>
